...
function onMoveApplied() {
  ...
  if (currentGameId) {
    ...
    }).catch(e => console.warn("turnInfo update failed", e));
  }

  // Start local timer (will be synced from Firebase for both players)
